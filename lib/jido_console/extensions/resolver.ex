defmodule Jido.Console.Extensions.Resolver do
  ...
  defp load_records(opts) do
    files = Keyword.get(opts, :extension_record_files, Application.get_env(:jido_console, :extension_record_files, []))
