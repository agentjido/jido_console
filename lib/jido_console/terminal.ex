defmodule Jido.Console.Terminal do
  @moduledoc """
  Small, injectable terminal boundary for Jido applications.

  The adapter owns all terminal effects. `Jido.Console.Terminal.Input` and
  `Jido.Console.Terminal.Frame` are pure and can be tested without a TTY.
  """
  ...
  def open(opts \\ []) do
    adapter = Keyword.get(opts, :adapter, Jido.Console.Terminal.OTP)
