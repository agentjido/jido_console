defmodule Jido.Cli.Coding.WorkspaceConfig do
  ...
  def working_directory(opts) do
    Keyword.get(
      ...
      Application.get_env(:jido_cli, :coding_working_directory, ".")
    )
  end
    ...
    Workspace.new(
      ...
      limits:
        Keyword.get(
          opts,
          :coding_limits,
          Application.get_env(:jido_cli, :coding_limits, if(local?, do: @local_limits, else: %{}))
        ),
