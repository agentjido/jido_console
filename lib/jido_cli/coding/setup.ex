defmodule Jido.Cli.Coding.Setup do
  @moduledoc "Trusted CLI selection and context for the removable Jidoka coding pack."

  alias Jido.Cli.Coding.{FileMentions, Local, ProviderOptions, Selection, WorkspaceConfig}
  ...
  @type t :: %__MODULE__{
          ...
          extension_setup: Jido.Cli.Extensions.Setup.t(),
