defmodule Jido.Cli.Automation.Interrupt do
  @moduledoc """
  ...
  @message_tag :jido_cli_automation_cancel
...
defmodule Jido.Cli.Automation.Interrupt.Signal do
  @moduledoc """
  ...
  @impl Jido.Cli.Automation.Interrupt
