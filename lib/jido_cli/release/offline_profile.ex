defmodule Jido.Cli.Release.OfflineProfile do
  ...
  defp registration do
    with {:ok, fixture_json} <- File.read(fixture_path()) do
      ...
      {:ok,
       Registration.new!(
         profile: profile,
         adapter: Jido.Cli.Release.ForbiddenEnvironmentAdapter,
...
defmodule Jido.Cli.Release.ForbiddenEnvironmentAdapter do
  @moduledoc false
