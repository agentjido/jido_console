defmodule Jido.Console.Release.LicenseAudit do
  ...
  defp source_identity!("jido_console", version, project_root) do
    {:project, "https://github.com/agentjido/jido_console@#{version}", ["Apache-2.0"], project_root}
  end
