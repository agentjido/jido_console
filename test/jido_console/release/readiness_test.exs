defmodule Jido.Console.Release.ReadinessTest do
  ...
  test "uses the existing deterministic TUI state and layout suite" do
    ...
    assert "test/jido_console/cli/tui/editor_test.exs" in args
    assert "test/jido_console/cli/tui/state_test.exs" in args
    assert "test/jido_console/cli/tui/view_test.exs" in args
  end
  ...
  test "runs the bounded terminal and real PTY suite" do
    ...
    assert "test/jido_console/cli/tui_test.exs" in args
