defmodule Jido.Console.ReqLLMDependencyTest do
  ...
  if System.get_env("JIDO_CONSOLE_JIDOKA_PATH") do
    test "the local Jidoka adapter accepts ReqLLM decoded object parts" do
      ...
      assert Jidoka.Effect.LLMDecision.name(decision) == "lookup"
      assert Jidoka.Effect.LLMDecision.arguments(decision) == %{}
