defmodule Jido.Cli.Automation.LimitsTest do
  use ExUnit.Case, async: true

  alias Jido.Cli.Automation.Engine.Jidoka, as: JidokaEngine
  alias Jido.Cli.Automation.{Coordinator, JSONL, Limits, Result}
  ...
  test "rejects an oversized matrix and a ceiling escalation before artifacts", %{root: root} do
    ...
    assert {:error, :configuration, {:automation_limit_exceeds_ceiling, :max_cells, 3, 2}} =
             Jido.Cli.Automation.execute(["eval", raised, "--output", raised_output],
