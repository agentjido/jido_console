%Doctor.Config{
  # Internal implementation modules, macros, and terminal adapters are not part
  # of the public API surface. Public Jido.Console modules remain documented.
  ignore_modules: [
    ~r/^Jido\.Console\.MixProject$/,
    ~r/^Jido\.Console\.Error\.Type$/,
